...
[NORMAL] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,    KC_F16,  KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | xxx  |  INS | HOME | PGUP |  xxx |  xxx |                    |  xxx | xxx  |  xxx |  xxx |  xxx |  DEL |
 * |------+------+------+------+------+------|        Rot: F14/F15|------+------+------+------+------+------|
...
[RAISED] = LAYOUT(
  ...
  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F13, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [NORMAL] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),  ENCODER_CCW_CW(KC_F17, KC_F18)  },
    [RAISED] = { ENCODER_CCW_CW(KC_NO, KC_NO),  ENCODER_CCW_CW(KC_F14, KC_F15)  },
};
#endif
